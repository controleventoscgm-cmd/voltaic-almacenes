...
Copia todo el texto que está entre las líneas de "====".
Abre el Bloc de Notas.
Pega el texto.
Dale a "Archivo > Guardar como...".
En "Tipo", elige "Todos los archivos (.)".
Ponle de nombre README.md y guárdalo en la carpeta de tu proyecto.